                ...
                <div id="page-content">
                  ...
                  <article class="postlist-item" id="post-<?php the_id(); ?>">
                    ...
                    <header class="postlist-header">
                      ...
                      <!-- Post information -->
                      <p class="postlist-header-meta">Postat den <time datetime="<?php the_time('c') ?>"><?php the_time('j M, Y') ?></time> i <span class="post-cats"><?php the_category(', ') ?></span> <span class="post-author-meta"><a href="#"><?php the_author(); ?></a></span></p>
                      ...
                      <figure class="align-center">
                        <span class="element-holder">
                          <?php if ( has_post_thumbnail() ) { ?>
                           <a class="post-related-item element-holder media-link" href="<?php the_permalink() ?>" title="Permanent länk till <?php the_title_attribute(); ?>">
                  ...
                  <section class="post-author">
                    ...
                    <a class="post-author-image element-holder media-link" href="#" title="Författarens avatar">
                      <?php echo get_avatar( get_the_author_meta('ID'), 60, get_template_directory_uri().'/images/avatar.png', '' ); ?>
                    </a>
                    <!-- End - Post author image -->
                    <!-- Post author information -->
                    <div class="post-author-content">
                      <h4><?php echo $the_bloguser; ?></h4>
                      <p>Jag som skrivit detta inlägg heter <strong><?php the_author(); ?></strong>. Inlägget postades <strong><time datetime="<?php the_time('c') ?>"><?php the_time('j M, Y - H:i') ?></time></strong>, du kan följa uppdateringar till detta inlägg via <?php post_comments_feed_link('RSS-flödet'); ?>.</p>
                    </div>
