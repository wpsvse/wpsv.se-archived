        ...
        <div id="page-body-content-inner">
          <!-- Page content -->
                <div id="page-content">
				  ...
				  ?>
                  <h2>Visar filer i kategorin <?php echo $dterm->name; ?></h2>
                  <span>Denna kategori innehåller <strong><?php echo $total_results; ?></strong> fil(er)</span>
                  ...
                  <!-- File item -->
                  <article class="filelist-item <?php echo $dterm->slug; ?>">
                    <!-- Post header -->
